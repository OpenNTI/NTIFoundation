...
/**
 * Creates a UIColor object by parsing a string which textually represents red, green, and blue hex-values, with alpha specified separately.
 ...
 * @return A UIColor object with red, green, and blue values as represented by |hexString| and alpha value specified by |alpha|.
 */
