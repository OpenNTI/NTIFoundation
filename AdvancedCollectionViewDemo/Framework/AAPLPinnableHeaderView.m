...
- (void)applyLayoutAttributes:(CollectionViewLayoutAttributes *)layoutAttributes
{
    if (![layoutAttributes isKindOfClass:[CollectionViewLayoutAttributes class]])
        return;

    self.hidden = layoutAttributes.hidden;
    self.userInteractionEnabled = !layoutAttributes.isEditing;
    ...
    self.pinned = layoutAttributes.isPinned;
}
