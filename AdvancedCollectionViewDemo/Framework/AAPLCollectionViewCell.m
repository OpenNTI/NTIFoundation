...
@interface CollectionViewLayoutAttributes ()

@property (nonatomic, readonly) AAPLTheme *theme;
...
- (void)createSubviewsForActions:(NSArray *)actions
{
    ...
    [actions enumerateObjectsWithOptions:NSEnumerationReverse usingBlock:^(AAPLAction *buttonAction, NSUInteger actionIndex, BOOL *stop) {
        ...
        NSString *title = buttonAction.title;
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    if ([layoutAttributes isKindOfClass:[CollectionViewLayoutAttributes class]]) {
        CollectionViewLayoutAttributes *attributes = (CollectionViewLayoutAttributes *)layoutAttributes;
        ...
        self.movable = attributes.isMovable;
        self.editing = attributes.isEditing;
...
- (UICollectionViewLayoutAttributes *)preferredLayoutAttributesFittingAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    CollectionViewLayoutAttributes *newAttributes = [attributes copy];
...
- (void)appl_invalidateCollectionViewLayout
{
    ...
    CollectionViewLayoutInvalidationContext *context = [[[[layout class] invalidationContextClass] alloc] init];
